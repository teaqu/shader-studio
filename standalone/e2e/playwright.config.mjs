...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'chromium', testMatch: ['web.e2e.mjs', 'wgsl-storage.e2e.mjs', 'wgsl-vertex-editor.e2e.mjs', 'symbol-rename.e2e.mjs', 'workspace-references.e2e.mjs', 'wgsl-language-service.e2e.mjs'], use: { browserName: 'chromium', launchOptions: { args: ['--enable-unsafe-webgpu'] } } },
