...
export const SHADER_STUDIO_BUILTIN_UNIFORMS = deepFreezeBuiltinCatalog([
  ...
  { name: "iChannelN", glslType: "sampler2D | samplerCube | sampler3D", slangType: "sampleIChannelN helper / configured texture alias", languages: ["glsl", "slang"], description: "Any renderer-assigned input channel; slots follow configured input order and are not inferred from resource names." },
