# Slang browser runtime notice

Shader Studio distributes the official Slang 2026.10.2 browser JavaScript and
WebAssembly runtime from <https://github.com/shader-slang/slang/releases/tag/v2026.10.2>.
The same runtime supplies both shader compilation and the language-server API;
Shader Studio does not distribute `slangd` or any native executable.
