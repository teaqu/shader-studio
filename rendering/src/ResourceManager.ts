...
export class ResourceManager {
  ...
  private readonly volumeTextureManager: VolumeTextureManager;
  ...
  constructor(
    ...
    this.volumeTextureManager = new VolumeTextureManager(renderer);
  ...
  public async loadVolumeTexture(
    ...
    return this.volumeTextureManager.loadVolumeTexture(path, opts);
  }

  public getVolumeTexture(path: string): PiTexture | null {
    return this.volumeTextureManager.getVolumeTexture(path);
  }
  ...
  public cleanup(): void {
    ...
    this.volumeTextureManager.cleanup();
