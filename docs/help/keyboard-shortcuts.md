...
| `:bnext` / `:bn` | Switch to next buffer tab |
| `:bprev` / `:bp` | Switch to previous buffer tab |
| `:buffer name` / `:b name` | Jump to a named buffer tab |
