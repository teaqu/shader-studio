...
| `shader-studio.languageServers.wgsl.enabled` | boolean | `true` | No | Enable [WGSL completion, hover, navigation, symbols, and colors](../features/language-servers.md). Compiler errors come from the WebGPU driver. |
