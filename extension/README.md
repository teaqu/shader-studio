...
📖 **Full documentation: [teaqu.github.io/shader-studio/docs](https://teaqu.github.io/shader-studio/docs/)**
...
See the [Quick Start guide](https://teaqu.github.io/shader-studio/docs/quick-start/) for a full walkthrough.
...
Runs the shader within a panel in VS Code, so you can view your shader alongside your code. Panels can be dragged, split, and resized; the layout saves automatically. See [Panel Layout](https://teaqu.github.io/shader-studio/docs/features/panel-layout/).

### Web Browser

For the best performance, run the preview in your web browser. Browsers tend to have better GPU optimizations and higher-priority rendering than VS Code panels. See [Open in Browser](https://teaqu.github.io/shader-studio/docs/features/web-server/).
...
See [Configure Buffers and Inputs](https://teaqu.github.io/shader-studio/docs/features/config-buffers/) and [Channels](https://teaqu.github.io/shader-studio/docs/features/channels/) for the full guides, and [my shaders repository](https://github.com/teaqu/shaders/tree/main/shadertoy) for examples.
...
Debug mode works inside `mainImage`, helper functions, and buffer passes. See [Debug Mode Overview](https://teaqu.github.io/shader-studio/docs/debugging/).
...
See [Time and Playback Controls](https://teaqu.github.io/shader-studio/docs/features/time-controls/).
...
See the full [Shadertoy Compatibility reference](https://teaqu.github.io/shader-studio/docs/help/shadertoy-compatibility/).

## Documentation

The complete user guide lives at **[teaqu.github.io/shader-studio](https://teaqu.github.io/shader-studio/docs/)**, including troubleshooting, keyboard shortcuts, and settings.
