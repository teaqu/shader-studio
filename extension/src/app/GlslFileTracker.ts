...
export function isWgslDocument(document: vscode.TextDocument): boolean {
  return document.languageId === 'wgsl' || document.fileName.endsWith('.wgsl');
}

/** Any shader source we can preview (GLSL, Slang, or WGSL). */
