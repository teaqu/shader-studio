...
/**
 * The WebGPU mirror of script-pause.e2e.mjs: uniform scripts run in the
 * extension host however the shader renders, so a paused Slang or WGSL picture must
 ...
 */
export function registerScriptPauseTests(language) {
