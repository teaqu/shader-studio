// Image renders the model while BufferA renders the visor pattern.
// WGSL mirror of ../slang/two-meshes.slang. Config (two-meshes.sha.json)
// binds the GLB model with the visor.vertex.wgsl hook.
