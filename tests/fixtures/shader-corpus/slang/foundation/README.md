> Note: this repo splits tests by language. These fixtures live under `slang/foundation/`; open the workspace root and preview the listed paths below. See the root README.
